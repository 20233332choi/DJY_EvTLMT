...
/* ★2026-09 기계파트 설계보고서와 대조. 보고서의 rpm↔속도 표로 역검증됨:
 *   v[m/s] = motor_rpm ÷ GEAR_RATIO ÷ 60 × 2π × TIRE_RADIUS
 *   2000rpm→43.3km/h(보고서 43), 3000→65.0(65), 4425→95.9(96) ✓
 ...
 *  그대로 전파된다. */
#define TIRE_RADIUS         0.230f   /* 타이어 반경 [m] — keizer 10" FSAE 슬릭 */
...
#define SAS_CENTER_RAW          9175   /* 2026-09-19 user-selected zero: wireless 14 samples, mean 9174.64 */
